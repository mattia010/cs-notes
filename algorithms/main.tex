...
\newtheorem{prop}[thm]{Proposizioe}
\newtheorem{lem}[thm]{Lemma}
\newtheorem{conj}[thm]{Congettura}
\newtheorem{quest}[thm]{Domanda}
\newtheorem{claim}{Claim}
\newtheorem{property}{Proprietà}

\theoremstyle{definition}
\newtheorem{defn}[thm]{Definizione}
\newtheorem{defns}[thm]{Definizioni}
\newtheorem{con}[thm]{Costruzione}
\newtheorem{exmp}[thm]{Esempio}
\newtheorem{exmps}[thm]{Esempi}
\newtheorem{notn}[thm]{Notazione}
\newtheorem{notns}[thm]{Notazioni}
\newtheorem{addm}[thm]{Addendum}
\newtheorem{exer}[thm]{Esercizio}

\theoremstyle{remark}
\newtheorem{rem}[thm]{Osservazione}
\newtheorem{ans}[thm]{Risposta}
\newtheorem{rems}[thm]{Osservazioni}
\newtheorem{warn}[thm]{Avvertimento}
